...
function HighestCashback(props) {
    // console.log(props.highestCashback);
  ...
  const highestCashback = props.highestCashback
  return (
    <div className="my-16 highestCashback">
        <p className="text-[20px] font-semibold mb-5 lg:ps-0 ps-4">Highest Cashback</p>
      ...
      <Slider
        ...
        {...sliderSettings}
      >
        {highestCashback?.map((card, index) => (
...
export default HighestCashback;
